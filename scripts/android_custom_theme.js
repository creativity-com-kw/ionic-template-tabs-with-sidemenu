...
module.exports = function (ctx) {
    ...
    var manifestPath = path.join(ctx.project.dir, 'platforms/android/app/src/main/AndroidManifest.xml');
    ...
    doc.getroot().find('./application/activity').attrib["android:theme"] = "@style/customTheme";
